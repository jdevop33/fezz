...
const ProductDetail = () => {
    ...
    const fetchProduct = async () => {
      ...
      try {
        ...
        if (docSnap.exists()) {
          ...
          // For demonstration purposes we're using dummy data for related products
          const dummyRelated = [
            { 
              id: 'cherry-6mg', 
              name: 'Cherry Light', 
  ...
  const handleAddToCart = () => {
    ...
    // Show confirmation toast or navigate to cart
  };
                ...
                <div className="flex text-warning-400">
                  {[...Array(5)].map((_, i) => (
                    <Star 
                      ...
                      className={i < Math.floor(4.5) ? "text-warning-400" : "text-surface-300"} 
                    />
                  ))}
                </div>
                ...
                <div key={relatedProduct.id} className="group relative">
                  <div className="overflow-hidden rounded-lg bg-surface-100">
                    <img
                      ...
                      alt={relatedProduct.name || relatedProduct.flavor}
                  ...
                  <div className="mt-4">
                    <h3 className="text-sm font-medium text-surface-900">
                      {relatedProduct.name || `${relatedProduct.flavor} ${relatedProduct.strength}mg`}
                    </h3>
                  ...
                  <Link
                    ...
                    aria-label={`View ${relatedProduct.name || relatedProduct.flavor} product`}
                  >
                    View Product
                  </Link>
                </div>
