  ...
  return (
    <div className="min-h-screen bg-white dark:bg-surface-900 transition-colors duration-200">
      ...
      <section className="relative overflow-hidden bg-black min-h-[90vh]">
        {/* Background gradient overlay for hero image */}
        ...
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="PUXX Premium Experience" 
            className="object-cover object-left h-full w-full opacity-90"
          />
        </div>
        
        {/* Premium animated background effects */}
        <div className="absolute inset-0 z-20 opacity-30 mix-blend-screen pointer-events-none">
          <div className="absolute h-56 w-56 rounded-full bg-puxx-premium-500/20 blur-3xl animate-pulse-premium left-1/4 top-1/3"></div>
          <div className="absolute h-72 w-72 rounded-full bg-red-500/10 blur-3xl animate-pulse-premium animation-delay-1000 right-1/4 top-1/2"></div>
          <div className="absolute h-40 w-40 rounded-full bg-puxx-premium-400/20 blur-3xl animate-pulse-premium animation-delay-2000 left-1/3 bottom-1/4"></div>
        </div>
        
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-32 pb-20 relative z-30">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            {/* Content column */}
            <div className="space-y-8 animate-premium-fade-in">
              <div className="space-y-2">
                <span className="inline-flex items-center rounded-full bg-puxx-premium-900/30 px-3 py-1 text-sm font-medium text-puxx-premium-300 backdrop-blur-sm border border-puxx-premium-800/30 shadow-sm">
                  <span className="mr-1.5 h-1.5 w-1.5 rounded-full bg-puxx-premium-400 animate-pulse"></span>
                  Premium Nicotine Experience
                </span>
                <h1 className="font-display text-5xl sm:text-6xl md:text-7xl font-bold tracking-tight text-white leading-none">
                  Elevate Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-puxx-premium-400 to-puxx-premium-600">Moments</span>
                </h1>
                <p className="text-xl sm:text-2xl text-surface-200 font-light mt-6 max-w-xl leading-tight">
                  Precision Crafted for Those Who Demand Excellence
                </p>
              </div>
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                <Link
                  ...
                  bg-gradient-to-r from-puxx-premium-600 to-puxx-premium-700 text-white font-premium font-medium tracking-wide
                  shadow-lg hover:shadow-puxx-premium-500/20 transition-all hover:from-puxx-premium-700 hover:to-puxx-premium-800
                  focus:outline-none focus:ring-2 focus:ring-puxx-premium-500 focus:ring-offset-2 focus:ring-offset-black group"
                >
                  Experience PUXX
                ...
                <Link
                  to="/products"
                  className="inline-flex items-center justify-center px-6 py-3 rounded-md 
                  bg-surface-900/60 backdrop-blur-sm text-white font-premium font-medium tracking-wide
                  border border-surface-700/50 transition-all hover:bg-surface-800/80 hover:border-surface-600/50
                  focus:outline-none focus:ring-2 focus:ring-surface-500 focus:ring-offset-2 focus:ring-offset-black"
                >
                  Discover Our Craft
                </Link>
              </div>
              ...
              {/* Trust indicators */}
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-8 border-t border-surface-800/50">
                <div className="flex items-start">
                  <div className="flex-shrink-0 rounded-full bg-puxx-premium-900/30 p-2 border border-puxx-premium-800/30">
                    <Shield className="h-5 w-5 text-puxx-premium-400" />
                  </div>
                  <div className="ml-3">
                    <p className="text-sm font-semibold text-white">Superior Quality</p>
                ...
                <div className="flex items-start">
                  <div className="flex-shrink-0 rounded-full bg-puxx-premium-900/30 p-2 border border-puxx-premium-800/30">
                    <Star className="h-5 w-5 text-puxx-premium-400" />
                  </div>
                  <div className="ml-3">
                    <p className="text-sm font-semibold text-white">Perfect Balance</p>
                ...
                <div className="flex items-start">
                  <div className="flex-shrink-0 rounded-full bg-puxx-premium-900/30 p-2 border border-puxx-premium-800/30">
                    <FlaskConical className="h-5 w-5 text-puxx-premium-400" />
                  </div>
                  <div className="ml-3">
                    <p className="text-sm font-semibold text-white">Revolutionary Design</p>
            ...
            <div className="relative lg:ml-12 mt-4 lg:mt-0">
              {/* Main product display */}
              <div className="relative flex justify-center items-center">
                {/* Glowing backdrop for product */}
                <div className="absolute inset-0 bg-gradient-to-br from-puxx-premium-800/20 via-puxx-premium-500/10 to-transparent rounded-full blur-2xl"></div>
                ...
                <div className="relative z-10 transition-all duration-700 hover:scale-105">
                  <img 
                    ...
                    className="max-w-xs lg:max-w-sm mx-auto drop-shadow-2xl"
                  />
                  
                  {/* Premium badge */}
                  <div className="absolute -top-2 -right-2 bg-gradient-to-br from-puxx-premium-500 to-puxx-premium-700 rounded-full p-3 shadow-lg">
                    <div className="h-14 w-14 rounded-full border-2 border-dashed border-white/70 flex items-center justify-center text-white font-bold">
                      <div className="text-center">
                        <span className="text-xs block">PREMIUM</span>
                        <span className="text-sm block">QUALITY</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="absolute top-1/4 -left-4 transform -translate-y-1/2">
                <div className="bg-surface-900/80 backdrop-blur-md border border-surface-800/50 rounded-lg p-3 shadow-xl max-w-[160px]">
                  <div className="flex items-start space-x-3">
                    <div className="text-puxx-premium-400 text-xl font-bold">01</div>
                    <div>
                      <h4 className="text-sm font-bold text-white">Precision Crafted</h4>
                      <p className="text-xs text-surface-400 mt-1">Engineered for consistent release and maximum comfort</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Strength indicator */}
              <div className="absolute bottom-1/4 right-0 backdrop-blur-md bg-black/60 border border-surface-800/50 rounded-xl p-4 shadow-xl">
                <div className="flex flex-col items-center">
                  <div className="text-xs uppercase text-surface-300 font-semibold tracking-wider">Strength Profile</div>
                  <div className="mt-2 w-32 h-2 rounded-full bg-surface-800 overflow-hidden">
                    <div className="w-3/4 h-full bg-gradient-to-r from-yellow-500 to-orange-500"></div>
                  </div>
                  <div className="mt-2 text-2xl font-bold text-white">16<span className="text-sm text-surface-400">mg</span></div>
                  <p className="text-xs text-surface-400 mt-1 max-w-[140px] text-center">Bold satisfaction for discerning users</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Feature highlights */}
        <div className="bg-gradient-to-b from-black to-surface-950 backdrop-blur-sm py-12 relative z-30 border-t border-surface-800/20">
          <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="group flex flex-col items-center text-center p-6 rounded-xl hover:bg-surface-900/20 transition-all duration-300">
                <div className="h-12 w-12 rounded-full bg-puxx-premium-900/30 border border-puxx-premium-800/30 flex items-center justify-center mb-4 group-hover:bg-puxx-premium-800/40 transition-all">
                  <span className="text-puxx-premium-400 text-xl font-bold group-hover:scale-110 transition-all">01</span>
                </div>
                <span className="text-puxx-premium-400 text-lg font-bold mb-2">Smoke-Free</span>
                <p className="text-surface-300 text-sm">A cleaner alternative delivering nicotine without the smoke, leaving no trace behind.</p>
              </div>
              
              <div className="group flex flex-col items-center text-center p-6 rounded-xl hover:bg-surface-900/20 transition-all duration-300">
                <div className="h-12 w-12 rounded-full bg-puxx-premium-900/30 border border-puxx-premium-800/30 flex items-center justify-center mb-4 group-hover:bg-puxx-premium-800/40 transition-all">
                  <span className="text-puxx-premium-400 text-xl font-bold group-hover:scale-110 transition-all">02</span>
                </div>
                <span className="text-puxx-premium-400 text-lg font-bold mb-2">Discreet Elegance</span>
                <p className="text-surface-300 text-sm">Enjoy your moments confidently with our odorless pouches, perfect for any setting.</p>
              </div>
              
              <div className="group flex flex-col items-center text-center p-6 rounded-xl hover:bg-surface-900/20 transition-all duration-300">
                <div className="h-12 w-12 rounded-full bg-puxx-premium-900/30 border border-puxx-premium-800/30 flex items-center justify-center mb-4 group-hover:bg-puxx-premium-800/40 transition-all">
                  <span className="text-puxx-premium-400 text-xl font-bold group-hover:scale-110 transition-all">03</span>
                </div>
                <span className="text-puxx-premium-400 text-lg font-bold mb-2">Effortless Satisfaction</span>
                <p className="text-surface-300 text-sm">No lighting, no charging, no maintenance—ready when you are, wherever life takes you.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-black/80 backdrop-blur-sm py-2 text-center text-xs text-surface-400 border-t border-surface-800/30 z-50">
